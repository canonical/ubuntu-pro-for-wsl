...
require (
	github.com/canonical/ubuntu-pro-for-wsl/agentapi v0.0.0-20241016125530-8e2e2124233d
	github.com/canonical/ubuntu-pro-for-wsl/common v0.0.0-20241118165654-124fffa50a0a
