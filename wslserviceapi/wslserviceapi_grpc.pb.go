...
func (c *wSLClient) ProAttach(ctx context.Context, in *AttachInfo, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/wslserviceapi.WSL/ProAttach", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wSLClient) Ping(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/wslserviceapi.WSL/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _WSL_ProAttach_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/wslserviceapi.WSL/ProAttach",
	}
...
func _WSL_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/wslserviceapi.WSL/Ping",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
