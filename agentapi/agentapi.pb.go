...
var file_agentapi_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x61, 0x70, 0x69, 0x22, 0x9a, 0x01, 0x0a, 0x0a, 0x44,
	...
	0x6f, 0x72, 0x74, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0x30, 0x0a, 0x02,
	0x55, 0x49, 0x12, 0x2a, 0x0a, 0x04, 0x50, 0x69, 0x6e, 0x67, 0x12, 0x0f, 0x2e, 0x61, 0x67, 0x65,
...
var file_agentapi_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_agentapi_proto_goTypes = []interface{}{
	(*DistroInfo)(nil), // 0: agentapi.DistroInfo
	(*Port)(nil),       // 1: agentapi.Port
	(*Empty)(nil),      // 2: agentapi.Empty
}
var file_agentapi_proto_depIdxs = []int32{
	2, // 0: agentapi.UI.Ping:input_type -> agentapi.Empty
	0, // 1: agentapi.WSLInstance.Connected:input_type -> agentapi.DistroInfo
	2, // 2: agentapi.UI.Ping:output_type -> agentapi.Empty
	1, // 3: agentapi.WSLInstance.Connected:output_type -> agentapi.Port
