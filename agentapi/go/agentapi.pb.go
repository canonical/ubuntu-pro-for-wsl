...
type SubscriptionInfo struct {
	...
	ProductId        string                              `protobuf:"bytes,5,opt,name=productId,proto3" json:"productId,omitempty"` // The ID of the Ubuntu Pro For Windows product on the Microsoft Store.
}
...
func (x *SubscriptionInfo) GetManual() *Empty {
	if x, ok := x.GetSubscriptionType().(*SubscriptionInfo_Manual); ok {
		return x.Manual
	}
	return nil
}
...
type SubscriptionInfo_None struct {
	None *Empty `protobuf:"bytes,1,opt,name=none,proto3,oneof"` // The user does not have an active subscription
}

type SubscriptionInfo_Manual struct {
	Manual *Empty `protobuf:"bytes,2,opt,name=manual,proto3,oneof"` // The user manages its own subscription via the GUI and the registry
}

type SubscriptionInfo_MicrosoftStore struct {
	MicrosoftStore *Empty `protobuf:"bytes,3,opt,name=microsoftStore,proto3,oneof"` // The user manages its own subscription via the Microsoft store
}

type SubscriptionInfo_Organization struct {
	Organization *Empty `protobuf:"bytes,4,opt,name=organization,proto3,oneof"` // An administrator manages the subscription via the registry
}

func (*SubscriptionInfo_None) isSubscriptionInfo_SubscriptionType() {}

func (*SubscriptionInfo_Manual) isSubscriptionInfo_SubscriptionType() {}
...
var file_agentapi_proto_rawDesc = []byte{
	...
	,
...
var file_agentapi_proto_goTypes = []interface{}{
	...
	(*SubscriptionInfo)(nil), // 4: agentapi.SubscriptionInfo
}
var file_agentapi_proto_depIdxs = []int32{
	0, // 0: agentapi.SubscriptionInfo.none:type_name -> agentapi.Empty
	0, // 1: agentapi.SubscriptionInfo.manual:type_name -> agentapi.Empty
	0, // 2: agentapi.SubscriptionInfo.microsoftStore:type_name -> agentapi.Empty
	0, // 3: agentapi.SubscriptionInfo.organization:type_name -> agentapi.Empty
	1, // 4: agentapi.UI.ApplyProToken:input_type -> agentapi.ProAttachInfo
	0, // 5: agentapi.UI.Ping:input_type -> agentapi.Empty
	0, // 6: agentapi.UI.SubscpriptionInfo:input_type -> agentapi.Empty
	2, // 7: agentapi.WSLInstance.Connected:input_type -> agentapi.DistroInfo
	0, // 8: agentapi.UI.ApplyProToken:output_type -> agentapi.Empty
	0, // 9: agentapi.UI.Ping:output_type -> agentapi.Empty
	4, // 10: agentapi.UI.SubscpriptionInfo:output_type -> agentapi.SubscriptionInfo
	3, // 11: agentapi.WSLInstance.Connected:output_type -> agentapi.Port
