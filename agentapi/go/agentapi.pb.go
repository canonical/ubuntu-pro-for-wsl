...
type SubscriptionInfo_None struct {
	None *Empty `protobuf:"bytes,2,opt,name=none,proto3,oneof"` // The user does not have an active subscription
}

type SubscriptionInfo_Manual struct {
	Manual *Empty `protobuf:"bytes,3,opt,name=manual,proto3,oneof"` // The user manages its own subscription via the GUI and the registry
}

type SubscriptionInfo_MicrosoftStore struct {
	MicrosoftStore *Empty `protobuf:"bytes,4,opt,name=microsoftStore,proto3,oneof"` // The user manages its own subscription via the Microsoft store
}

type SubscriptionInfo_Organization struct {
	Organization *Empty `protobuf:"bytes,5,opt,name=organization,proto3,oneof"` // An administrator manages the subscription via the registry
}
...
var file_agentapi_proto_rawDesc = []byte{
	...
	,
