...
type UIClient interface {
	ApplyProToken(ctx context.Context, in *ProAttachInfo, opts ...grpc.CallOption) (*emptypb.Empty, error)
	Ping(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error)
	GetSubscriptionInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*SubscriptionInfo, error)
}
...
func (c *uIClient) ApplyProToken(ctx context.Context, in *ProAttachInfo, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *uIClient) Ping(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (c *uIClient) GetSubscriptionInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*SubscriptionInfo, error) {
...
type UIServer interface {
	ApplyProToken(context.Context, *ProAttachInfo) (*emptypb.Empty, error)
	Ping(context.Context, *emptypb.Empty) (*emptypb.Empty, error)
	GetSubscriptionInfo(context.Context, *emptypb.Empty) (*SubscriptionInfo, error)
...
func (UnimplementedUIServer) ApplyProToken(context.Context, *ProAttachInfo) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ApplyProToken not implemented")
}
func (UnimplementedUIServer) Ping(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Ping not implemented")
}
func (UnimplementedUIServer) GetSubscriptionInfo(context.Context, *emptypb.Empty) (*SubscriptionInfo, error) {
...
func _UI_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UIServer).Ping(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UI_GetSubscriptionInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UIServer).GetSubscriptionInfo(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
