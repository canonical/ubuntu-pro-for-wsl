...
func (c *wSLInstanceClient) ProAttachmentCommands(ctx context.Context, opts ...grpc.CallOption) (WSLInstance_ProAttachmentCommandsClient, error) {
	stream, err := c.cc.NewStream(ctx, &WSLInstance_ServiceDesc.Streams[1], "/agentapi.WSLInstance/ProAttachmentCommands", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *wSLInstanceClient) LandscapeConfigCommands(ctx context.Context, opts ...grpc.CallOption) (WSLInstance_LandscapeConfigCommandsClient, error) {
	stream, err := c.cc.NewStream(ctx, &WSLInstance_ServiceDesc.Streams[2], "/agentapi.WSLInstance/LandscapeConfigCommands", opts...)
	if err != nil {
		return nil, err
	}
