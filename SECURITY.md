...
user maintains full access to their own application data, cross-user data access is strictly
prohibited.
...
- [Ubuntu on WSL documentation](https://ubuntu.com/wsl/docs/stable/)
